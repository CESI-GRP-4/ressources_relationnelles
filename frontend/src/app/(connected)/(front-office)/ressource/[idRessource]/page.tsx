...
import { Avatar, message, Result, Spin, Tabs, TabsProps, Typography, Tooltip, Button } from "antd";
       ...
       const items: TabsProps["items"] = [
              {
                     ...
                     key: 'content',
                     children: <div><pre className='whitespace-pre-wrap' style={{ wordWrap: 'break-word' }}>{`ugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierngugneru_inerguierng`}</pre></div>
              },
              {
                     ...
                     {loading ? (
                            ...
                            <>
                                   ...
                                   <div className='flex flex-row justify-end space-x-2'>
                                          <Tooltip title={isFavorite ? "Enlever des favoris" : "Ajouter aux favoris"}>
                                                 {isFavorite ? (
                                          ...
                                          <Tooltip title={isBookmark ? `Enlever des "A regarder plus tard"` : `Ajouter à "A regarder plus tard"`}>
                                                 {isBookmark ? (
                                                        <Button
                                                               loading={loading}
                                                               onClick={() => {
